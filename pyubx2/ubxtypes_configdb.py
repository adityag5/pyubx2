...
UBX_CONFIG_DATABASE = {
    ...
    "CFG_MSGOUT_UBX_ESF_MEAS_I2C": (0x20910177, U1),
    "CFG_MSGOUT_UBX_ESF_MEAS_SPI": (0x2091017b, U1),
    "CFG_MSGOUT_UBX_ESF_MEAS_UART1": (0x20910178, U1),
    "CFG_MSGOUT_UBX_ESF_MEAS_UART2": (0x20910179, U1),
    "CFG_MSGOUT_UBX_ESF_MEAS_USB": (0x2091017a, U1),

    "CFG_MSGOUT_UBX_ESF_RAW_I2C": (0x2091019f, U1),
    "CFG_MSGOUT_UBX_ESF_RAW_SPI": (0x209101a3, U1),
    "CFG_MSGOUT_UBX_ESF_RAW_UART1": (0x209101a0, U1),
    "CFG_MSGOUT_UBX_ESF_RAW_UART2": (0x209101a1, U1),
    "CFG_MSGOUT_UBX_ESF_RAW_USB": (0x209101a2, U1),
    ...
    # CFG-SFIMU
    "CFG_SFIMU_GYRO_TC_UPDATE_PERIOD": (0x3006007, U2),
    ...
    "CFG_SFIMU_ACCEL_LATENCY": (0x20060017, U2),
    "CFG_SFIMU_ACCEL_ACCURACY": (0x30060018, U2),
    "CFG_SFIMU_IMU_EN": (0x1006001d, L),
    "CFG_SFIMU_IMU_I2C_SCL_PIO": (0x2006001e, U1),
    "CFG_SFIMU_IMU_I2C_SDA_PIO": (0x2006001d, U1),
    "CFG_SFIMU_IMU_AUTO_MNTALG_ENA": (0x10060027, L),
    "CFG_SFIMU_IMU_AUTO_MNTALG_YAW": (0x4006002d, U4),
    "CFG_SFIMU_IMU_AUTO_MNTALG_PITCH": (0x3006002e, I2),
    "CFG_SFIMU_IMU_AUTO_MNTALG_ROLL": (0x3006002f, I2),
